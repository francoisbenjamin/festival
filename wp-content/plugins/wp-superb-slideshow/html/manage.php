...
<div class="wrap">
	...
	<div class="dataTable_wrapper">
		<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
			...
			<?php superb_get_table_actions(array('superb_bulk_delete_albums' => 'Delete', 
											'superb_bulk_disable_albums' => 'Disable', 
											'superb_bulk_enable_albums' => 'Enable')); ?>
		</div>
		...
		<?php else: ?>
		<?php require_once SPB_PLUGIN_DIR . '/html/albums_rows.php'; ?>
		<?php endif; ?>
		</tbody>
		</table>
	...
	if( isset($_REQUEST['view']) && isset($_REQUEST['album_id']))
	{
		...
		$album = $gspb->superb_get_album($album_id);
		//print_r($album);
		$images = $gspb->superb_get_album_images($album_id);
		//print_r($images); 
		...
		if (!(strstr($_REQUEST['view'], '/')) && !(strstr($_REQUEST['view'], "\\"))) {
			require_once SPB_PLUGIN_DIR . '/html/' . $_REQUEST['view'] . '.php';
		}
	} 
	?>
</div>