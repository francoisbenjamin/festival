...
?>
<?php if(isset($gspb->messages['upload']) && is_array($gspb->messages['upload']) && count($gspb->messages['upload']) > 0): ?>
<div class="updated">
<p class="">
<?php foreach($gspb->messages['upload'] as $msg): ?>
	<span><?php print $msg; ?></span><br/>
<?php endforeach;?>
</p>
</div>
<?php endif; ?>
<script type="text/javascript">var superb_current_album_id = <?php print $album['album_id']; ?>;</script>
<div class="dataTable_wrapper">
	<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
		...
		<?php superb_get_table_actions(array('superb_bulk_delete_images' => 'Delete', 
											'superb_bulk_disable_images' => 'Disable', 
											'superb_bulk_enable_images' => 'Enable')); ?>
	</div>
	...
	<tbody>
	<?php require_once SPB_PLUGIN_DIR . '/html/images_rows.php'; ?>
	</tbody>
	</table>
...
<div id="single_upload" class="tab_content">
	<form id="single_upload_form" action="" method="post" enctype="multipart/form-data">
		<input type="hidden" name="task" value="superb_single_image_upload" />
...
-->
	...
	var superb_upload_dir = "<?php  /* add the replace "\\" to work on windows server */  print str_replace("\\","/",superb_get_album_dir($album['album_id'])); ?>";
	var superb_secw = "<?php 
	global $wpdb;
	$query = "SELECT txt FROM {$wpdb->prefix}superb_misc WHERE ione=1 AND itwo=1 AND ithree=1 LIMIT 1";
